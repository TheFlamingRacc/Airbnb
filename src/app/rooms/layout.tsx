...
const details = ["2 гостя", "1 спальня", "1 ліжко", "1 ванна кімната"];
        ...
        >
          ...
          >
            ...
            >
              <Box>
                <Typography fontSize={25} fontWeight={700} color="text.primary">
                  Варшава, Польща: Помешкання для оренди цілком
                </Typography>
                ...
                <Typography
                  ...
                  display={"flex"}
                >
                  <StarIcon fontSize="inherit" /> 4.98 •{" "}
              ...
              <Box display="flex" gap={4} alignItems="flex-start">
                ...
                >
                  ...
                  <Typography color="text.secondary">
                    Деякі приміщення в помешканні використовуватимуться спільно
                    з іншими гостями.
                  </Typography>
                </Box>
              </Box>
              ...
              <Typography color="text.primary">
                Капсульна кімната - це приватний вільний простір, який дозволить
                вам відпочити й почуватися комфортно. У номері є ортопедичний
                матрац, кондиціонер, Wi-Fi, шафка для речей. Ванна кімната
                розташована на підлозі.
              </Typography>
              <Divider />
              <Typography fontSize={25} fontWeight={700} color="text.primary">
                Які тут зручності
